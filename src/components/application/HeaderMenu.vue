<template>
  <div id="header-menu" class="no-print">
    <span class="menuHoverOpen">
      <a href="javascript:" @click.prevent><img src="@/img/more_vert-24px.svg"/></a>
      <div class="menu">
        <ul>
          <li @click="github"><img src="@/img/github.svg" width="24" height="24" /> <span>GitHub Project</span></li>
          <li @click="save"><img src="@/img/save-24px.svg" width="24" height="24" /> <span>Already Saved Automatically</span></li>
          <li @click="RESET_STATE"><img src="@/img/delete_sweep-24px.svg" width="24" height="24" /> <span>Reset Numbers</span></li>
        </ul>
      </div>
    </span>
  </div>
